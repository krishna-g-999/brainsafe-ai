...
def render_report(compound_name, data):
    ...
    _dim_scores_100 = {
        "antioxidant":            data.get("antioxidant", 0) * 10,
        "anti_inflammatory":      data.get("anti_inflammatory", 0) * 10,
        "mitochondrial_support":  data.get("mitochondrial_support", 0) * 10,
        "aggregation_modulation": data.get("aggregation_modulation", 0) * 10,
        "cognitive_enhancement":  data.get("cognitive_enhancement", 0) * 10,
        "neurogenesis":           data.get("neurogenesis", 0) * 10,
        "synaptic_plasticity":    data.get("synaptic_plasticity", 0) * 10,
    }
