...
1,881 live files. The two large directories are `models_rf/`, which holds the deployed
...
| Category | Files | MB |
|---|---|---|
| Deployed model artefacts and metadata | 254 | 879 |
| Result tables | 92 | 781 |
| Root: application, build and project files | 874 | 477 |
| External structure libraries | 19 | 251 |
| Reviewer package | 147 | 238 |
| Source data as retrieved | 9 | 210 |
| Derived data tables | 46 | 34 |
| Training data, per endpoint | 67 | 19 |
| Manuscript | 58 | 18 |
| Documentation | 36 | 10 |
| Inversion and falsification analysis | 38 | 7 |
| Manuscript figures | 9 | 4 |
| Read-across index inputs | 22 | 3 |
| Training data, ADME endpoints | 10 | 2 |
| Source logos | 2 | 2 |
| Source code | 157 | 1 |
| Application assets | 5 | 1 |
| Result figures | 11 | 1 |
| Deployment instructions | 8 | 0 |
| Supplementary tables | 16 | 0 |
| Graph-network comparison results | 1 | 0 |

## The pipeline, in the order it runs

389 scripts. `SCRIPT_INDEX.csv` gives each one's purpose and what it writes.

| Stage | Scripts |
|---|---|
| 1. Data acquisition | 18 |
| 2. Data assembly and audit | 18 |
| 3. Featurisation | 2 |
| 4. Model training | 8 |
...
| 8. Evaluation | 37 |
| 9. Inversion and falsification | 10 |
| 10. Analysis and reporting | 34 |
...
Everything superseded was moved into one dated archive folder (618 files, 4.92 GB), listed file by file
